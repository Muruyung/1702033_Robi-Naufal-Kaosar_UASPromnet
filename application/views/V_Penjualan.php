...
<body>
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"> <span>Add New Penjualan</span></a>
					</div>
				</div>
			</div>
      <?php
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="<?php echo site_url('C_Penjualan/add'); ?>" method="post">
              ...
              <select name="uangmuka">
								<?php foreach ($uangmuka->data as $key) {
									?>
	...
	<div id="updateEmployeeModal<?php echo $key->id;?>" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="<?php echo site_url('C_Penjualan/update/'.$key->id); ?>" method="post">
					<div class="modal-header">
	...
	foreach($Penjualan as $key){
		...
		<div id="deleteEmployeeModal<?php echo $key->id;?>" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					<form action="<?php echo site_url('C_Penjualan/delete/'.$key->id); ?>" method="POST">
						<div class="modal-header">
